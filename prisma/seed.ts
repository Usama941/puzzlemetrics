...
async function main() {
  ...
  // ── 3. TEAM MEMBERS ───────────────────────────────
  // Skipped: team members are managed via /admin/team.
  // Demo upserts (tm-alex, tm-sarah, …) were overwriting real data on every seed run.
  console.log("⏭️ Team members seed skipped");
